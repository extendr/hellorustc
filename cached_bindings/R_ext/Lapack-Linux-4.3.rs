...
unsafe extern "C" {
    ...
    #[doc = " DGEEQU - compute row and column scalings intended to equilibrate */\n/* an M-by-N matrix A and reduce its condition number"]
    pub fn dgeequ_(
        m: *const ::std::os::raw::c_int,
        n: *const ::std::os::raw::c_int,
        a: *mut f64,
    ...
    #[doc = " DLAED2 - merge the two sets of eigenvalues together into a */\n/* single sorted set"]
    pub fn dlaed2_(
        k: *const ::std::os::raw::c_int,
        n: *const ::std::os::raw::c_int,
        d: *mut f64,
  ...
  between KSTART and KSTOP"]
    ...
    #[doc = " DLAED8 - merge the two sets of eigenvalues together into a */\n/* single sorted set"]
    pub fn dlaed8_(
        icompq: *const ::std::os::raw::c_int,
        k: *const ::std::os::raw::c_int,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " DLASWP - perform a series of row interchanges on the matrix A"]
    pub fn dlaswp_(
        n: *const ::std::os::raw::c_int,
        a: *mut f64,
        lda: *const ::std::os::raw::c_int,
    ...
    #[doc = " This returns Fortran LOGICAL.  Compiler-specific, but\nint_least32_t in gfortran"]
    pub fn lsame_(
