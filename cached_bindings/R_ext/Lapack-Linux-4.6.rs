...
unsafe extern "C" {
    ...
    pub fn ilaenv_(
        ispec: *const ::std::os::raw::c_int,
        name: *const ::std::os::raw::c_char,
        opts: *const ::std::os::raw::c_char,
        n1: *const ::std::os::raw::c_int,
        n2: *const ::std::os::raw::c_int,
        n3: *const ::std::os::raw::c_int,
        n4: *const ::std::os::raw::c_int,
        arg1: usize,
        arg2: usize,
    ) -> ::std::os::raw::c_int;
    #[doc = " DISNAN returns .TRUE. if its argument is NaN, and .FALSE. otherwise. */\n/*        To be replaced by the Fortran 2003 intrinsic in the future."]
    pub fn disnan_(din: *const ::std::os::raw::c_int) -> ::std::os::raw::c_int;
 ...
 - compute a QR factorization of a real m by n matrix A"]
    ...
    #[doc = " DPOTRF2  computes the Cholesky factorization of a real symmetric */\n/* positive definite matrix A using the recursive algorithm."]
    pub fn dpotrf2_(
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
        a: *mut f64,
    ...
    #[doc = " DPFTRF computes the Cholesky factorization of a real symmetric */\n/* positive definite matrix A (which is in RFP format)."]
    pub fn dpftrf_(
    ...
    #[doc = " DSYEQUB computes row and column scalings intended to equilibrate a */\n/* symmetric matrix A (with respect to the Euclidean norm) and reduce */\n/* its condition number."]
    pub fn dsyequb_(
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
        a: *const f64,
    ...
    #[doc = " DTFSM solves a matrix equation ('a' is a triangular matrix in Rectangular Full Packed (RFP)"]
    pub fn dtfsm_(
        transr: *const ::std::os::raw::c_char,
        side: *const ::std::os::raw::c_char,
        uplo: *const ::std::os::raw::c_char,
    ...
    #[doc = " DTPTTR copies a triangular matrix from the standard packed format (TP) to the standard full format (TR)"]
    pub fn dtpttr_(
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
        ap: *const f64,
    ...
    #[doc = " DTRTTP copies a triangular matrix from the standard full format (TR) to the standard packed format (TP)"]
    pub fn dtrttp_(
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
        a: *const f64,
    ...
    #[doc = " DLAED4 - subroutine computes the I-th updated eigenvalue of a */\n/* symmetric rank-one modification to a diagonal mut ::std::os::raw::c_int,
    ...
    #[doc = " DTRTTF copies a triangular matrix from the standard full format (TR) to the rectangular full packed (RFP) format (TF)"]
    pub fn dtrttf_(
        transr: *const ::std::os::raw::c_char,
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " ZGEBAL balances a general complex matrix A"]
    pub fn zgebal_(
        job: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
        a: *mut Rcomplex,
    ...
    #[doc = " ZHEEVD computes the eigenvalues and, optionally, the left and/or right eigenvectors for HE matrices\n Added in R 4.5.0"]
    pub fn zheevd_(
        jobz: *const ::std::os::raw::c_char,
        uplo: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " ZGELS solves overdetermined or underdetermined systems for GE matrices"]
    pub fn zgels_(
        trans: *const ::std::os::raw::c_char,
        m: *const ::std::os::raw::c_int,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " ZGESVX computes the solution to system of linear equations A * X = B for GE matrices"]
    pub fn zgesvx_(
        fact: *const ::std::os::raw::c_char,
        trans: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " ZGGES computes the eigenvalues, the Schur form, and, optionally, the matrix of Schur vectors for GE matrices"]
    pub fn zgges_(
        jobvsl: *const ::std::os::raw::c_char,
        jobvsr: *const ::std::os::raw::c_char,
        sort: *const ::std::os::raw::c_char,
        selctg: *mut ::std::os::raw::c_void,
        n: *const ::std::os::raw::c_int,
        a: *mut Rcomplex,
        lda: *const ::std::os::raw::c_int,
        b: *mut Rcomplex,
    ...
    #[doc = " ZGGEV computes the eigenvalues and, optionally, the left and/or right eigenvectors for GE matrices"]
    pub fn zggev_(
        jobvl: *const ::std::os::raw::c_char,
        jobvr: *const ::std::os::raw::c_char,
        n: *const ::std::os::raw::c_int,
    ...
    #[doc = " ZLARTG generates a plane rotation with real cosine and complex sine"]
    pub fn zlartg_(
        F: *const Rcomplex,
        G: *const Rcomplex,
        C: *mut f64,
    ...
    #[doc = " ZROT applies a plane rotation with real cosine and complex sine to a pair of complex vectors"]
    pub fn zrot_(
        n: *const ::std::os::raw::c_int,
        cx: *mut Rcomplex,
        incx: *const ::std::os::raw::c_int,
