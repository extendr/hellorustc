...
unsafe extern "C" {
    ...
    pub fn GA_setuserfilterW(arg1: *const wchar_t);
    pub fn GA_askfilenameW(
        title: *const ::std::os::raw::c_char,
        default_name: *const ::std::os::raw::c_char,
    ) -> *mut wchar_t;
    pub fn GA_askfilenamesW(
        title: *const wchar_t,
    ...
    pub fn GA_gcopyalpha2(d: drawing, src: image, r: rect);
    ...
    pub fn GA_gdrawimage(d: drawing, img: image, dr: rect, sr: rect);
    pub fn GAI_gmaskimage(d: drawing, img: image, dr: rect, sr: rect, mask: image);
    pub fn GA_gdrawstr(
        d: drawing,
        f: font,
        c: rgb,
